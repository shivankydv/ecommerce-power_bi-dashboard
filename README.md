...
This Power BI dashboard analyzes ecommerce sales data to understand performance across states, categories, customers, and payment modes.

## 🧰 Tools Used:
Power BI Desktop
CSV Dataset (Orders & Details)
